...
<head>
    ...
    <title>Produk</title>
    <link rel="canonical" href="/assets/images/wk.png" />
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/images/wk.png">
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="../assets/images/wk.png" alt="homepage" class="dark-logo" style="width: 50px" />
                            <!-- Light Logo icon -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="{{ route('product.data') }}" aria-expanded="false"><i
                                    class="mdi mdi-account-network"></i><span class="hide-menu">Product</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
        ...
        <div class="page-wrapper">
            ...
            <div class="container">
                <div class="card mx-4 mx-md-5 shadow-5-strong p-4">
                    <form action="{{ route('kirim-data') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col mb-3">
